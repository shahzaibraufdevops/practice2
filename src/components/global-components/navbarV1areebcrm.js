          ...
          <div className="container">
            <div className="row">
                      ...
                      <ul>
                        ...
                        <li className="menu-icon">
                          ...
                          <ul>
                            ...
                            <li><Link to="/staff-management">Staff</Link></li>
                            <li><Link to="/commission-management">Commission</Link></li>
                            <li><Link to="/report-management">Report</Link></li>
                            <li><Link to="/digital-tools">Digital Tools</Link></li>
                            <li><Link to="/sales-target">Sales Target</Link></li>
                          </ul>
                        </li>
                        {/* <li className="menu-icon">
              ...
              <div className="col--- ltn__header-options ltn__header-options-2 ">
                {/* Mobile Menu Button */}
                <div className={`mobile-menu-toggle d-xl-none ${istrue && "d-none"}`}>
                  <a
                ...
                <button className={`ltn__utilize-close ${!istrue && "d-none"}`} style={{
                  width: "50px",
                  height: "50px",
                  background: "white",
                  ...
                  // marginTop:'-12%',
                  color: "black"
                }} onClick={() => setistrue(false)}>x</button>
